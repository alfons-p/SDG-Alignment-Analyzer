#!/usr/bin/env python3
"""Create CSV from SDG alignment results and analyze SDG 17 activities."""
...
def analyze_sdg17(results):
    """Analyze all activities classified as SDG 17."""
    print("\n" + "="*80)
...
def main():
    ...
    # Analyze SDG 17
    sdg17_activities = [a for a in activities if a.get('primary_sdg') == 17]
